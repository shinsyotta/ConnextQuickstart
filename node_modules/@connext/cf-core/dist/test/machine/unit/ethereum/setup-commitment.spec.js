...
describe("SetupCommitment", () => {
    ...
    const stateChannel = models_1.StateChannel.setupChannel(networkContext.IdentityApp, utils_1.getAddress(utils_1.hexlify(utils_1.randomBytes(20))), [interaction.sender, interaction.receiver]);
