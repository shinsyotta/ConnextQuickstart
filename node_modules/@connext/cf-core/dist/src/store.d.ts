...
export declare class Store {
    ...
    constructor(storeService: Node.IStoreService, storeKeyPrefix: string);
    ...
    getProposedAppInstances(): Promise<AppInstanceProposal[]>;
    ...
    getWithdrawalCommitment(multisigAddress: string): Promise<Node.MinimalTransaction>;
    storeWithdrawalCommitment(multisigAddress: string, commitment: Node.MinimalTransaction): Promise<void>;
    setCommitment(args: any[], commitment: Node.MinimalTransaction): Promise<void>;
    getAppInstance(appInstanceId: string): Promise<AppInstance>;
    getOrCreateStateChannelBetweenVirtualAppParticipants(multisigAddress: string, initiatorXpub: string, responderXpub: string): Promise<StateChannel>;
}
