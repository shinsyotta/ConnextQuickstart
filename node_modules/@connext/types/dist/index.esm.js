import { BigNumber as BigNumber$1, getAddress } from 'ethers/utils';
...
var UnidirectionalTransferAppActionType;
...
})(UnidirectionalTransferAppActionType || (UnidirectionalTransferAppActionType = {}));
var UnidirectionalTransferAppStage;
...
})(UnidirectionalTransferAppStage || (UnidirectionalTransferAppStage = {}));
var UnidirectionalLinkedTransferAppStage;
...
})(UnidirectionalLinkedTransferAppStage || (UnidirectionalLinkedTransferAppStage = {}));
...
const ConnextEvents = Object.assign({}, CFCoreTypes.EventNames, { RECIEVE_TRANSFER_FAILED_EVENT: "RECIEVE_TRANSFER_FAILED_EVENT", RECIEVE_TRANSFER_FINISHED_EVENT: "RECIEVE_TRANSFER_FINISHED_EVENT", RECIEVE_TRANSFER_STARTED_EVENT: "RECIEVE_TRANSFER_STARTED_EVENT" });
...
const ChannelProviderRpcMethods = Object.assign({}, CFCoreTypes.RpcMethodNames, ConnextRpcMethods);

const getType = (input) => {
    if (typeof input === "string")
        return "str";
    if (BigNumber$1.isBigNumber(input))
        return "bignumber";
...
const castFunctions = {
    ...
    "number-bignumber": (x) => new BigNumber$1(x),
    "number-str": (x) => x.toString(),
    "str-bignumber": (x) => new BigNumber$1(x),
};
...
export { BigNumber, CFCoreTypes, CF_PATH, ChannelProviderRpcMethods, ConnextClientStorePrefix, ConnextEvents, ConnextNodeStorePrefix, ConnextRpcMethods, EXPECTED_CONTRACT_NAMES_IN_NETWORK_CONTEXT, OutcomeType, SupportedApplications, SupportedNetworks, TransferConditions, TwoPartyFixedOutcome, UnidirectionalLinkedTransferAppStage, UnidirectionalTransferAppActionType, UnidirectionalTransferAppStage, coinBalanceRefundStateEncoding, convert, convertAmountField, convertAppState, convertAssetAmount, convertAssetAmountWithId, convertCoinBalanceRefund, convertDepositParametersToAsset, convertFields, convertLinkedTransferAppState, convertLinkedTransferParametersToAsset, convertLinkedTransferToRecipientParametersToAsset, convertPaymentProfile, convertSwapParameters, convertTransferParametersToAsset, convertWithdrawParametersToAsset, makeChecksum, makeChecksumOrEthAddress, multiAssetMultiPartyCoinTransferEncoding, multiAssetMultiPartyCoinTransferInterpreterParamsEncoding, singleAssetTwoPartyCoinTransferInterpreterParamsEncoding, twoPartyFixedOutcomeInterpreterParamsEncoding, virtualAppAgreementEncoding };
