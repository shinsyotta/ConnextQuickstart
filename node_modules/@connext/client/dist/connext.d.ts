...
import { Address, AppInstanceJson, AppRegistry, CFCoreChannel, CFCoreTypes, ChannelProviderConfig, ChannelState, CheckDepositRightsResponse, ConditionalTransferParameters, ConditionalTransferResponse, CreateChannelResponse, DefaultApp, DepositParameters, GetConfigResponse, IConnextClient, InternalClientOptions, PaymentProfile, ResolveConditionParameters, ResolveLinkedTransferResponse, Store, SwapParameters, Transfer, TransferParameters, WithdrawalResponse, WithdrawParameters } from "./types";
export declare class ConnextClient implements IConnextClient {
    ...
    getLinkedTransfer: (paymentId: string) => Promise<Transfer<string>>;
    ...
    rescindDepositRights: (params: Pick<DepositParameters<string>, "assetId">) => Promise<CFCoreTypes.DepositResult>;
    checkDepositRights: (params: Pick<DepositParameters<string>, "assetId">) => Promise<CheckDepositRightsResponse<string>>;
    swap: (params: SwapParameters<string>) => Promise<CFCoreChannel>;
    transfer: (params: TransferParameters<string>) => Promise<ConditionalTransferResponse>;
    ...
    cleanupRegistryApps: () => Promise<void>;
    removeHangingProposalsByDefinition: (appDefinitions: string[]) => Promise<void>;
    uninstallAllAppsByDefintion: (appDefinitions: string[]) => Promise<void>;
    uninstallCoinBalanceIfNeeded: (assetId?: string) => Promise<void>;
