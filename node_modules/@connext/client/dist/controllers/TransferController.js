    ...
    constructor() {
        ...
        this.resolveInstallTransfer = (res, data) => {
            if (this.appId !== data.params.appInstanceId) {
                this.log.info(`Caught INSTALL_VIRTUAL event for different app ${lib_1.stringify(data)}, expected ${this.appId}`);
                res();
                return;
            }
            res(data);
            ...
            try {
                yield Promise.race([
                    new Promise((res, rej) => {
                        ...
                        this.listener.on(types_1.CFCoreTypes.EventName.INSTALL_VIRTUAL, boundResolve);
                        this.listener.on(types_1.CFCoreTypes.EventName.REJECT_INSTALL_VIRTUAL, boundReject);
                    }),
        ...
        this.cleanupInstallListeners = (boundResolve, boundReject) => {
            this.listener.removeListener(types_1.CFCoreTypes.EventName.INSTALL_VIRTUAL, boundResolve);
