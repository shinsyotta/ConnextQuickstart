...
__decorate([
    rpc_server_1.jsonRpcMethod(types_1.Node.RpcMethodName.PROPOSE_INSTALL),
...
function assertSufficientFundsWithinFreeBalance(channel, publicIdentifier, tokenAddress, depositAmount) {
    if (!channel.hasFreeBalance)
        return;
    const freeBalanceForToken = channel.getFreeBalanceClass().getBalance(tokenAddress, machine_1.xkeyKthAddress(publicIdentifier, 0)) ||
        constants_1.Zero;
