...
class NodeApiClient {
    ...
    set channelRouter(channelRouter) {
    ...
    resolveLinkedTransfer(paymentId, preImage, recipientPublicIdentifier) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    getAuthToken() {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                ...
                const sig = yield this.channelRouter.signMessage(nonce);
    ...
    assertAuthToken() {
        if (!this.channelRouter) {
            throw new Error(`Must have instantiated a channel router (ie a signing thing) before setting auth token`);
        }
        if (!this.token) {
            this.token = this.getAuthToken();
        }
    ...
    send(subject, data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (guardedSubjects.includes(subject.split(".")[0])) {
                ...
                payload.token = yield this.token;
            }
            let msg = yield this.messaging.request(subject, lib_1.NATS_TIMEOUT, payload);
