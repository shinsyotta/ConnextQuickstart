...
class DepositController extends controller_1.NodeController {
    ...
    async executeMethodImplementation(requestHandler, params) {
        ...
        const payload = {
            ...
            type: types_1.NODE_EVENTS.DEPOSIT_CONFIRMED,
            data: params
        };
        await messagingService.send(counterpartyAddress, payload);
        outgoing.emit(types_1.NODE_EVENTS.DEPOSIT_CONFIRMED, payload);
...
__decorate([
    rpc_server_1.jsonRpcMethod(types_1.Node.RpcMethodName.DEPOSIT),
