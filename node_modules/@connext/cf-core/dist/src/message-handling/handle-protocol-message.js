...
async function handleReceivedProtocolMessage(requestHandler, msg) {
    ...
    const outgoingEventData = await getOutgoingEventDataFromProtocol(protocol, params, postProtocolStateChannelsMap, networkContext, store);
...
async function getOutgoingEventDataFromProtocol(protocol, params, stateChannelsMap, networkContext, store) {
    ...
    switch (protocol) {
        case machine_1.Protocol.Propose:
            ...
            return Object.assign({}, baseEvent, { type: types_1.NODE_EVENTS.PROPOSE_INSTALL, data: {
        ...
        case machine_1.Protocol.Install:
            return Object.assign({}, baseEvent, { type: types_1.NODE_EVENTS.INSTALL, data: {
                    params: {
                        appInstanceId: stateChannelsMap
                            .get(params.multisigAddress)
        ...
        case machine_1.Protocol.Uninstall:
            return Object.assign({}, baseEvent, { type: types_1.NODE_EVENTS.UNINSTALL, data: getUninstallEventData(params) });
        case machine_1.Protocol.Setup:
            return Object.assign({}, baseEvent, { type: types_1.NODE_EVENTS.CREATE_CHANNEL, data: getSetupEventData(params, stateChannelsMap.get(params.multisigAddress)
                    .multisigOwners) });
        case machine_1.Protocol.Withdraw:
            return Object.assign({}, baseEvent, { type: types_1.NODE_EVENTS.WITHDRAWAL_STARTED, data: getWithdrawEventData(params) });
        case machine_1.Protocol.TakeAction:
        case machine_1.Protocol.Update:
            return Object.assign({}, baseEvent, { type: types_1.NODE_EVENTS.UPDATE_STATE, data: getStateUpdateEventData(params, stateChannelsMap
                    .get(params.multisigAddress)
                    .getAppInstance(params.appIdentityHash).state) });
        case machine_1.Protocol.InstallVirtualApp:
            const virtualChannel = await store.getMultisigAddressWithCounterparty([params.responderXpub, params.initiatorXpub], networkContext.ProxyFactory, networkContext.MinimumViableMultisig, networkContext.provider);
            if (stateChannelsMap.has(virtualChannel)) {
                return Object.assign({}, baseEvent, { type: types_1.NODE_EVENTS.INSTALL_VIRTUAL, data: {
                        params: {
                            appInstanceId: stateChannelsMap
                                .get(virtualChannel)
                                .mostRecentlyInstalledAppInstance().identityHash
        ...
        case machine_1.Protocol.UninstallVirtualApp:
            return Object.assign({}, baseEvent, { type: types_1.NODE_EVENTS.UNINSTALL_VIRTUAL, data: getUninstallVirtualAppEventData(params) });
        default:
...
async function getQueueNamesListByProtocolName(protocol, params, requestHandler) {
    ...
    async function multisigAddressFor(xpubs) {
        const allowGenerated = protocol === machine_1.Protocol.Setup || protocol === machine_1.Protocol.InstallVirtualApp;
        return await store.getMultisigAddressWithCounterparty(xpubs, networkContext.ProxyFactory, networkContext.MinimumViableMultisig, allowGenerated ? provider : undefined);
    }
    switch (protocol) {
        case machine_1.Protocol.Install:
        case machine_1.Protocol.Setup:
