...
class ConnextListener extends events_1.EventEmitter {
    constructor(channelRouter, connext) {
        super();
        this.defaultCallbacks = {
            COUNTER_DEPOSIT_CONFIRMED: (msg) => {
                this.emitAndLog(types_1.CFCoreTypes.EventName.COUNTER_DEPOSIT_CONFIRMED, msg.data);
            },
            CREATE_CHANNEL: (msg) => {
                this.emitAndLog(types_1.CFCoreTypes.EventName.CREATE_CHANNEL, msg.data);
            },
            DEPOSIT_CONFIRMED: (msg) => __awaiter(this, void 0, void 0, function* () {
                this.emitAndLog(types_1.CFCoreTypes.EventName.DEPOSIT_CONFIRMED, msg.data);
            }),
            DEPOSIT_FAILED: (msg) => {
                this.emitAndLog(types_1.CFCoreTypes.EventName.DEPOSIT_FAILED, msg.data);
            },
            DEPOSIT_STARTED: (msg) => {
                const { value, txHash } = msg.data;
                this.log.info(`deposit for ${value.toString()} started. hash: ${txHash}`);
                this.emitAndLog(types_1.CFCoreTypes.EventName.DEPOSIT_STARTED, msg.data);
            },
            INSTALL: (msg) => {
                this.emitAndLog(types_1.CFCoreTypes.EventName.INSTALL, msg.data);
            },
            INSTALL_VIRTUAL: (msg) => {
                this.emitAndLog(types_1.CFCoreTypes.EventName.INSTALL_VIRTUAL, msg.data);
            },
            PROPOSE_INSTALL: (msg) => __awaiter(this, void 0, void 0, function* () {
                this.emitAndLog(types_1.CFCoreTypes.EventName.PROPOSE_INSTALL, msg.data);
            ...
            PROTOCOL_MESSAGE_EVENT: (msg) => {
                this.emitAndLog(types_1.CFCoreTypes.EventName.PROTOCOL_MESSAGE_EVENT, msg.data);
            },
            REJECT_INSTALL: (msg) => {
                this.emitAndLog(types_1.CFCoreTypes.EventName.REJECT_INSTALL, msg.data);
            },
            REJECT_INSTALL_VIRTUAL: (msg) => {
                this.emitAndLog(types_1.CFCoreTypes.EventName.REJECT_INSTALL_VIRTUAL, msg.data);
            },
            UNINSTALL: (msg) => {
                this.emitAndLog(types_1.CFCoreTypes.EventName.UNINSTALL, msg.data);
            },
            UNINSTALL_VIRTUAL: (msg) => {
                this.emitAndLog(types_1.CFCoreTypes.EventName.UNINSTALL_VIRTUAL, msg.data);
            },
            UPDATE_STATE: (msg) => {
                this.emitAndLog(types_1.CFCoreTypes.EventName.UPDATE_STATE, msg.data);
            },
            WITHDRAWAL_CONFIRMED: (msg) => {
                this.emitAndLog(types_1.CFCoreTypes.EventName.WITHDRAWAL_CONFIRMED, msg.data);
            },
            WITHDRAWAL_FAILED: (msg) => {
                this.emitAndLog(types_1.CFCoreTypes.EventName.WITHDRAWAL_FAILED, msg.data);
            },
            WITHDRAWAL_STARTED: (msg) => {
                const { params: { amount }, txHash, } = msg.data;
                this.log.info(`withdrawal for ${amount.toString()} started. hash: ${txHash}`);
                this.emitAndLog(types_1.CFCoreTypes.EventName.WITHDRAWAL_STARTED, msg.data);
            },
        };
        ...
        this.registerCfListener = (event, cb) => {
            ...
            this.channelRouter.on(event, (res) => __awaiter(this, void 0, void 0, function* () {
                yield cb(res);
                this.emit(event, res);
            }));
        };
        ...
        this.registerDefaultListeners = () => {
            Object.entries(this.defaultCallbacks).forEach(([event, callback]) => {
                this.channelRouter.on(types_1.CFCoreTypes.EventName[event], callback);
            });
            this.channelRouter.on(types_1.CFCoreTypes.RpcMethodName.INSTALL, (msg) => __awaiter(this, void 0, void 0, function* () {
            ...
            this.channelRouter.on(types_1.CFCoreTypes.RpcMethodName.UNINSTALL, (data) => {
                const result = data.result.result;
                this.log.debug(`Emitting CFCoreTypes.RpcMethodName.UNINSTALL event: ${lib_1.stringify(result)}`);
        ...
        this.emitAndLog = (event, data) => {
            const protocol = event === types_1.CFCoreTypes.EventName.PROTOCOL_MESSAGE_EVENT
                ? data.data
                    ? data.data.protocol
                    : data.protocol
                : "";
