...
exports.connect = (opts) => __awaiter(this, void 0, void 0, function* () {
    ...
    if (!myChannel) {
        ...
        const creationEventData = yield new Promise((res, rej) => __awaiter(this, void 0, void 0, function* () {
            ...
            channelRouter.once(types_2.CFCoreTypes.EventName.CREATE_CHANNEL, (data) => {
                clearTimeout(timer);
                res(data.data);
            });
    ...
    yield client.uninstallCoinBalanceIfNeeded();
...
class ConnextClient {
    constructor(opts) {
        ...
        this.rescindDepositRights = (assetId) => __awaiter(this, void 0, void 0, function* () {
            return yield this.channelRouter.rescindDepositRights(assetId);
        });
        ...
        this.getAppInstances = () => __awaiter(this, void 0, void 0, function* () {
            return (yield this.channelRouter.getAppInstances()).appInstances;
        });
        ...
        this.getProposedAppInstances = () => __awaiter(this, void 0, void 0, function* () {
            return yield this.channelRouter.getProposedAppInstances();
        });
        ...
        this.uninstallCoinBalanceIfNeeded = () => __awaiter(this, void 0, void 0, function* () {
            const coinRefund = (yield this.getAppInstances()).filter(app => {
            ...
            this.log.debug("Installed coin balance refund app found, checking if deposit has been executed");
            ...
            if (multisigBalance.eq(threshold)) {
                ...
                if (isClientDeposit) {
                    if (isTokenDeposit) {
                        new ethers_1.Contract(latestState["tokenAddress"], human_standard_token_abi_1.default, this.ethProvider).once("Transfer", () => __awaiter(this, void 0, void 0, function* () { return yield uninstallRefund(); }));
                    }
                    else {
