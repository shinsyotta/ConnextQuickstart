...
class DepositController extends AbstractController_1.AbstractController {
    ...
    registerListeners() {
        this.listener.registerCfListener(types_1.CFCoreTypes.EventName.DEPOSIT_CONFIRMED, this.depositConfirmedCallback);
        this.listener.registerCfListener(types_1.CFCoreTypes.EventName.DEPOSIT_FAILED, this.depositFailedCallback);
    }
    removeListeners() {
        this.listener.removeCfListener(types_1.CFCoreTypes.EventName.DEPOSIT_CONFIRMED, this.depositConfirmedCallback);
        this.listener.removeCfListener(types_1.CFCoreTypes.EventName.DEPOSIT_FAILED, this.depositFailedCallback);
    }
}
