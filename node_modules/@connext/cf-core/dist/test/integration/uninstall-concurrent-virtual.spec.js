...
describe("Concurrently uninstalling virtual and regular applications without issue", () => {
    ...
    it("can handle two concurrent TTT virtual app uninstalls", async (done) => {
        ...
        nodeC.on("UNINSTALL_VIRTUAL_EVENT", async (msg) => {
