...
import { AppActionBigNumber, AppRegistry, AppState, SupportedApplication, SupportedNetwork } from "./app";
...
import { ConditionalTransferParameters, ConditionalTransferResponse, DepositParameters, RequestDepositRightsParameters, ResolveConditionParameters, ResolveConditionResponse, ResolveLinkedTransferResponse, SwapParameters, TransferParameters, WithdrawParameters } from "./inputs";
...
export interface Store extends CFCoreTypes.IStoreService {
    set(pairs: {
        path: string;
        value: any;
    }[], shouldBackup?: Boolean): Promise<void>;
    restore(): Promise<{
        path: string;
        value: any;
    }[]>;
