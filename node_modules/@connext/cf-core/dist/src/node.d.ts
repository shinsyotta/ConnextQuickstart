...
export declare class Node {
    ...
    on(event: NodeTypes.EventName | NodeTypes.RpcMethodName, callback: (res: any) => void): void;
    off(event: NodeTypes.EventName | NodeTypes.RpcMethodName, callback?: (res: any) => void): void;
    once(event: NodeTypes.EventName | NodeTypes.RpcMethodName, callback: (res: any) => void): void;
    emit(event: NodeTypes.EventName | NodeTypes.RpcMethodName, req: NodeTypes.MethodRequest): void;
