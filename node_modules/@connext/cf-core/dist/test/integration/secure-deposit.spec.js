...
function confirmDepositMessages(initiator, responder, params) {
    ...
    initiator.once(src_1.NODE_EVENTS.DEPOSIT_STARTED, (msg) => {
        utils_1.assertNodeMessage(msg, startedMsg, ["data.txHash"]);
    });
    initiator.once(src_1.NODE_EVENTS.DEPOSIT_CONFIRMED, (msg) => {
        utils_1.assertNodeMessage(msg, confirmMsg);
    });
    responder.once(src_1.NODE_EVENTS.DEPOSIT_CONFIRMED, (msg) => {
        utils_1.assertNodeMessage(msg, confirmMsg);
    });
}
describe("Node method follows spec - deposit", () => {
    ...
    beforeEach(async () => {
        ...
        nodeB.off(src_1.NODE_EVENTS.DEPOSIT_CONFIRMED);
    });
