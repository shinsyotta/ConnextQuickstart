import { AppABIEncodings, AppInstanceJson, AppInstanceProposal, ContractABI, Node as NodeTypes, OutcomeType, SolidityValueType } from "@connext/types";
...
export declare function getFreeBalanceState(node: Node, multisigAddress: string, tokenAddress?: string): Promise<NodeTypes.GetFreeBalanceStateResult>;
export declare function getTokenIndexedFreeBalanceStates(node: Node, multisigAddress: string): Promise<NodeTypes.GetTokenIndexedFreeBalanceStatesResult>;
...
export declare function confirmProposedAppInstance(methodParams: NodeTypes.MethodParams, appInstanceProposal: AppInstanceProposal, nonInitiatingNode?: boolean): void;
...
export declare function confirmChannelCreation(nodeA: Node, nodeB: Node, ownersFreeBalanceAddress: string[], data: NodeTypes.CreateChannelResult): Promise<void>;
