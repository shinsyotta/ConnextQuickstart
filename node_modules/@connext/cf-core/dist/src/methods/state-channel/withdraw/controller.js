...
class WithdrawController extends controller_1.NodeController {
    ...
    async executeMethodImplementation(requestHandler, params) {
        ...
        try {
            ...
            outgoing.emit(types_1.NODE_EVENTS.WITHDRAWAL_FAILED_EVENT, {
                from: publicIdentifier,
                type: types_1.NODE_EVENTS.WITHDRAWAL_FAILED_EVENT,
                data: e.toString()
            });
            throw Error(`${errors_1.WITHDRAWAL_FAILED}: ${e.message}`);
        }
        return {
...
__decorate([
    rpc_server_1.jsonRpcMethod(types_1.CFCoreTypes.RpcMethodNames.chan_withdraw),
