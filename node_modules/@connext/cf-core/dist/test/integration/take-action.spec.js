...
function confirmMessages(initiator, responder, expectedData) {
    const expected = {
        ...
        type: src_1.NODE_EVENTS.UPDATE_STATE,
        data: expectedData,
    };
    responder.once(src_1.NODE_EVENTS.UPDATE_STATE, (msg) => {
...
describe("Node method follows spec - takeAction", () => {
    ...
    describe("Node A and B install an AppInstance, Node A takes action, " +
        ...
        it("can take action", async (done) => {
            ...
            nodeB.on(src_1.NODE_EVENTS.UPDATE_STATE, async (msg) => {
            ...
            await new Promise(resolve => {
                nodeA.once(src_1.NODE_EVENTS.UPDATE_STATE, () => {
