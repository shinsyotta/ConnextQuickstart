...
class WithdrawalController extends AbstractController_1.AbstractController {
    ...
    withdraw(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (!userSubmitted) {
                    this.log.info(`Calling ${types_1.CFCoreTypes.RpcMethodName.WITHDRAW_COMMITMENT}`);
                    ...
                    yield this.connext.store.set([
                        {
                            path: lib_1.withdrawalKey(this.connext.publicIdentifier),
                    ...
                    this.log.info(`Calling ${types_1.CFCoreTypes.RpcMethodName.WITHDRAW}`);
                ...
                this.log.error(`Failed to withdraw... ${lib_1.stringify(e)}`);
                this.removeListeners();
                throw new Error(e);
            }
            return {
    ...
    registerListeners() {
        this.listener.registerCfListener(types_1.CFCoreTypes.EventName.WITHDRAWAL_CONFIRMED, this.withdrawConfirmedCallback);
        this.listener.registerCfListener(types_1.CFCoreTypes.EventName.WITHDRAWAL_FAILED, this.withdrawFailedCallback);
    }
    removeListeners() {
        this.listener.removeCfListener(types_1.CFCoreTypes.EventName.WITHDRAWAL_CONFIRMED, this.withdrawConfirmedCallback);
        this.listener.removeCfListener(types_1.CFCoreTypes.EventName.WITHDRAWAL_FAILED, this.withdrawFailedCallback);
    }
}
