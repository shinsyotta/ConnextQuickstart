...
__decorate([
    rpc_server_1.jsonRpcMethod(types_1.Node.RpcMethodName.DEPLOY_STATE_DEPOSIT_HOLDER),
...
async function sendMultisigDeployTx(signer, stateChannel, networkContext, retryCount = 1) {
    const proxyFactory = new ethers_1.Contract(networkContext.ProxyFactory, contracts_1.ProxyFactory.abi, signer);
