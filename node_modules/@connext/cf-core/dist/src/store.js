...
class Store {
    ...
    async getProposedAppInstances() {
        return [...(await this.getStateChannelsMap()).values()].reduce((lst, sc) => [...lst, ...sc.proposedAppInstances.values()], []);
    }
    ...
    async getOrCreateStateChannelBetweenVirtualAppParticipants(multisigAddress, initiatorXpub, responderXpub) {
        try {
            ...
            if (e
                ...
                const stateChannel = models_1.StateChannel.createEmptyChannel(multisigAddress, [
                    initiatorXpub,
                    responderXpub
                ]);
            ...
            throw Error(utils_2.prettyPrintObject(e));
        }
    }
}
exports.Store = Store;
