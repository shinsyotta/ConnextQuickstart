...
class CreateChannelController extends controller_1.NodeController {
    ...
    async getRequiredLockNames() {
        return [types_1.Node.RpcMethodName.CREATE_CHANNEL];
    }
    async executeMethodImplementation(requestHandler, params) {
        ...
        if (!(await store.hasStateChannel(multisigAddress))) {
            await this.handleDeployedMultisigOnChain(multisigAddress, requestHandler, params);
        }
    ...
    async handleDeployedMultisigOnChain(multisigAddress, requestHandler, params) {
        ...
        const msg = {
            ...
            type: types_1.NODE_EVENTS.CREATE_CHANNEL,
            data: {
                multisigAddress,
        ...
        outgoing.emit(types_1.NODE_EVENTS.CREATE_CHANNEL, msg);
    }
}
__decorate([
    rpc_server_1.jsonRpcMethod(types_1.Node.RpcMethodName.CREATE_CHANNEL),
